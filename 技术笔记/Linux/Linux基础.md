...
![](https://zjpicture.oss-cn-beijing.aliyuncs.com/giteePic/picgo-master/img/20200715104822.jpg)
* **进程查看**
  * `top`工具：
...
* 核心模块的观察
  ...
  * 使用 lsmod 之后，系统会显示出目前已经存在於核心当中的模块，显示的内容包括有：模块名称(Module)；模块的大小(size)；此模块是否被其他模块所使用 (Used by)。
  ![](https://zjpicture.oss-cn-beijing.aliyuncs.com/giteePic/picgo-master/img/20200714234247.jpg)
* 核心模块的加载与移除：
...
* 示例：
![](https://zjpicture.oss-cn-beijing.aliyuncs.com/giteePic/picgo-master/img/20200715173315.jpg)
![](https://zjpicture.oss-cn-beijing.aliyuncs.com/giteePic/picgo-master/img/20200715173659.jpg)
![](https://zjpicture.oss-cn-beijing.aliyuncs.com/giteePic/picgo-master/img/20200715174224.jpg)
