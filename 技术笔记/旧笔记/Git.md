...
* 报错：
```
fatal: unable to access 'https://github.com/Jason-xy/UESTCBangBang.git/': OpenSSL SSL_read: Connection was reset, errno 10054
```
* 解决：在github项目在本地的根目录下打开git命令行，执行下面的命令：
